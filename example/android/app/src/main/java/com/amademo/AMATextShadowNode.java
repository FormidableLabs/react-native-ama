...
public class AMATextShadowNode extends ReactBaseTextShadowNode {
    ...
    public AMATextShadowNode(@Nullable ReactTextViewManagerCallback reactTextViewManagerCallback) {
    ...
    public void onBeforeLayout(NativeViewHierarchyOptimizer nativeViewHierarchyOptimizer) {
        Log.d("TAG: onBeforeLayout", mText);
    ...
    public void setText(@NonNull ReadableArray content) {
        ...
        for (int index = 0; index < content.size(); index++) {
            ReadableMap map = content.getMap(index);

            fullText.append(map.getString("text"));
        }

        mText = fullText.toString();
    }
