...
- Sets the [accessibilityRole](/guidelines/accessibility-role) property to **switch**
...
- Performs a check on the [accessibilityLabel](/guidelines/accessibility-label) <DevOnly />
