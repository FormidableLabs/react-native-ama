...
const AMAErrorComponent = ({ issues }: { issues?: A11yIssue[] }) => {
    ...
    return issues?.length ? (
        ...
        >
            ...
            >
                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }} role="button" aria-label="Show errors" activeOpacity={0.8}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }} role="button" aria-label="Show warnings" activeOpacity={0.8}>
