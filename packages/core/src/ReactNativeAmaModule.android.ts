...
// The legacy/classic RN bridge module registered by ReactNativeAmaPackage.kt
// (see packages/core/android/src/debug/java/expo/modules/ama/ReactNativeAmaModule.kt
// and ReactNativeAmaPackage.kt).
