...
- Sets the [accessibilityRole](../guidelines/accessibility-role.md) property to **switch**
...
- Performs a check on the [accessibilityLabel](../guidelines/accessibility-label.md) <DevOnly />
