...
ExpandablePressable is [Pressable](/docs/components/Pressable) component that automatically handles the [expanded](https://reactnative.dev/docs/accessibility#accessibilitystate) `accessibilityState`.
