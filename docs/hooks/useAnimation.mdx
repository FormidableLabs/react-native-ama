...
`useAnimation` is a hook that helps create accessible animations by honouring the user [Reduce Motion](../hooks/useAMAContext#isreducemotionenabled) preference.
